...
clustDir=${grpDir}/	##this file doesn't exist...how do I need to change this to fit MVM? --KZ
...
fileArr=(Clust_mask+tlrc.HEAD) 												# decon files from which betas will be extracted - should match step4.
